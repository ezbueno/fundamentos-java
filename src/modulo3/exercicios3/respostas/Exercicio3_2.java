package modulo3.exercicios3.respostas;
...
public class Exercicio3_2 {
	...
	/*
	 * Uma das formas de implementar o cálculo do fatorial é utilizar uma chamada
	 * recursiva, isto é, a função chama ela mesma.
	 */
	static int calcularFatorial(int num) {
		...
		// caso contrário, o fatorial é o número multiplicado pelo fatorial do seu
		// antecessor
