package modulo3.exercicios1.respostas;
...
public class Exercicio1 {
	...
	public static void main(String[] args) {
		...
		// cálculo da média, onde ocorre a soma das parciais, dividida pela soma dos
		// pesos
		// a presença dos parênteses é obrigatória para que as adições sejam feitas
		// antes da divisão
